...
> Άνοιγμα αυτής της σελίδας στο [https://ierotheos10.github.io/tug-of-led/](https://ierotheos10.github.io/tug-of-led/)
...
* αναζήτηση για **https://github.com/ierotheos10/tug-of-led** και εισαγωγή

## Επεξεργασία αυτού του έργου ![Σήμα κατάστασης κατασκευής](https://github.com/ierotheos10/tug-of-led/workflows/MakeCode/badge.svg)

Για επεξεργασία αυτού του αποθετηρίου στο MakeCode.

* άνοιγμα [https://makecode.microbit.org/](https://makecode.microbit.org/)
* κάντε κλικ στην **Εισαγωγή** και έπειτα στην **Εισαγωγή διεύθυνσης URL**
* επικολλήστε **https://github.com/ierotheos10/tug-of-led** και κάντε κλικ στην εισαγωγή
...
![Προβολή απόδοσης των μπλοκ](https://github.com/ierotheos10/tug-of-led/raw/master/.github/makecode/blocks.png)
